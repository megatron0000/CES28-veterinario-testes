...
public class AnimalTest {
    ...
    public void addSession() {
    	...
    	Session session1 = new Session(java.time.LocalDate.now(), this.cliente.getName(), "treatment1", "description1", this.animal);
    	this.animal.addSession(session1);
    	sessions.add(session1);
    	assertEquals(sessions, this.animal.getSessions());
    	
    	Session session2 = new Session(java.time.LocalDate.now(), this.cliente.getName(), "treatment2", "description2", this.animal);
